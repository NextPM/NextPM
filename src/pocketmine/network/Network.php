...
class Network{
	...
	private function registerPackets(){
		...
		$this->registerPacket(ProtocolInfo::LEVEL_CHUNK_PACKET, LevelChunkPacket::class);
		...
		$this->registerPacket(ProtocolInfo::SET_ACTOR_DATA_PACKET, SetActorDataPacket::class);
		$this->registerPacket(ProtocolInfo::SET_ACTOR_MOTION_PACKET, SetActorMotionPacket::class);
